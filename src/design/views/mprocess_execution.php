				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							<label for="fprecision" class="text-muted small" style="margin-bottom: 1px;margin-top: 7px;">Lote</label>
...
<div class="w-box" id="w_sort01">
	<div class="w-box-header">
		EVALUACIÓN DE LA CALIDAD DE JABÓN PRODUCIDO
		<div class="pull-right" ><?php if(boptionfilter('execution','received')){ echo "<a id='newdata' class='btn btn-success btn-xs'>Nuevo</a>"; }   ?></div>
	</div>
...
<div class="w-box" id="w_sort00">
	<div class="w-box-header">
		ESTADOS DE LA EVALUACIÓN DE LA CALIDAD DE JABÓN PRODUCIDO
	</div>
	<div class="w-box-content cnt_a">
		<div class="row">
            <div class="col-sm-12 col-md-12 ">
