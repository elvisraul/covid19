		...
		<div id="side_accordion" class="panel-group">
			<div class="panel panel-default">
				<div class="panel-heading">
					<a href="#collapseOne" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
						<i class="glyphicon glyphicon-folder-close"></i> Gestión
					</a>
				</div>
				<div class="accordion-body collapse" id="collapseOne">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><?php if(is_numeric(brole('process'))){ echo "<a href='javascript:void(0)' onclick='itemshow(\"proceso\");' >Proceso</a>";} ?></li>
							<li><?php if(is_numeric(brole('execution_soapsupplies'))){ echo "<a href='javascript:void(0)' onclick='itemshow(\"ejecutar_proceso_EIPJ\");' >E. Insumos Jabón</a>";} ?></li>
							<li><?php if(is_numeric(brole('execution'))){ echo "<a href='javascript:void(0)' onclick='itemshow(\"ejecutar_proceso\");' >EQ. Producción Jabón</a>";} ?></li>
							<li><?php if(is_numeric(brole('dispatch'))){ echo "<a href='javascript:void(0)' onclick='itemshow(\"despacho\");' >Despacho</a>";} ?></li>
								<!--<li><a href="javascript:void(0)" onclick="itemshow('precio');" >Precio</a></li>
								<li><a href="javascript:void(0)" onclick="itemshow('despacho');" >Despacho</a></li>
								
								<li><a href="javascript:void(0)" onclick="itemshow('produccion');" >Producción</a></li>-->
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<a href="#collapseTwo" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
						<i class="glyphicon glyphicon-th"></i> Proceso
					</a>
				</div>
				<div class="accordion-body collapse in" id="collapseTwo">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<!--<li><a href="javascript:void(0)" onclick="itemshow('requerimiento');" >Requerimiento</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('orden_compra');" >Orden de compra</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('compras');" >Registro de Facturas</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('salida');" >Registro de Salida</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('ingreso');" >Registro de Ingreso</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('existencia');" >Existencias</a></li>-->
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div class="accordion-body collapse" id="collapseThree">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<!--<li><a href="javascript:void(0)" onclick="itemshow('reportdespacho');" >Reporte Despachos</a></li>-->	
							<li><?php if(is_numeric(brole('dispatch_report'))){ echo "<a href='javascript:void(0)' onclick='itemshow(\"reportdespacho\");' >Reporte Despachos</a>";} ?></li>
						</ul>
				...
				<div class="accordion-body collapse" id="collapseFour">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<li>
								<a href="javascript:void(0)">IP Adress Blocking</a></li>
							<li class="nav-header">System</li>
							<li>
								<a href="javascript:void(0)">Site information</a></li>
							<li>
								<a href="javascript:void(0)">Actions</a></li>
							<li>
								<a href="javascript:void(0)">Cron</a></li>
							<li class="divider"></li>
							<li>
								<a href="javascript:void(0)">Help</a></li>-->
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="accordion-body collapse" id="collapse7">
					<div class="panel-body">
						<form name="Calc" id="calc">
							...
							Contributed by
							<a href="http://themeforest.net/user/maumao">maumao</a>
						</form>
					</div>
				</div>
			</div>
