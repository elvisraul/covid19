		...
		<div id="side_accordion" class="panel-group">
				...
				<div class="accordion-body collapse" id="collapseOne">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="javascript:void(0)" onclick="itemshow('personal');" >Personal</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('puesto');" >Puesto</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('permiso');" >Permiso</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="accordion-body collapse" id="collapseThree">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<!--<li><a href="javascript:void(0)" onclick="itemshow('kardex');" >Kardex</a></li>-->						</ul>
