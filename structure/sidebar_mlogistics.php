		...
		<div id="side_accordion" class="panel-group">
				...
				<div class="accordion-body collapse" id="collapseOne">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="javascript:void(0)" onclick="itemshow('questionario');" >Cuestionarios</a></li>
							<li><a href="javascript:void(0)" onclick="itemshow('pregunta');" >Preguntas</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div class="accordion-body collapse in" id="collapseTwo">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="javascript:void(0)" onclick="itemshow('asistencia');" >Asistencia</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div class="accordion-body collapse" id="collapseThree">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="javascript:void(0)" onclick="itemshow('reporte_asistencia');" >Asistencia</a></li>						</ul>
			...
			<div class="panel panel-default">
				...
				<div class="accordion-body collapse" id="collapseFour">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked"  hidden="true">
